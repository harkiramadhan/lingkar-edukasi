        ...
        <div class="coursedetail-hero_card">
          <div class="hero-content_left is-60">
            <div class="margin-bottom-20">
              <h1 class="heading-xxlarge is-white no-margin">Tingkatkan keterampilan dan karier mu!</h1>
            </div>
              ...
              <div data-w-tab="Tab 1" class="w-tab-pane w--tab-active">
                <div class="coursedetails-tabcontent">
                  <div class="coursedetail-richtext w-richtext">
                    ...
                    <p>Donec nulla massa, feugiat id ornare quis, consequat non massa. Nunc pulvinar ac arcu eu rhoncus. Morbi condimentum dolor in tortor commodo cursus id euismod purus. Sed sit amet odio eget sapien tristique ultricies interdum sed nisi. Curabitur molestie porttitor elementum. Donec eu diam lectus. Nunc vel blandit nibh. Duis eget posuere augue. Quisque vehicula laoreet urna quis pulvinar.</p>
