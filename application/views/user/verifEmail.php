    ...
    <div class="padding-vertical padding-80">
      <div class="container">
        <div class="flex-vertical">
          <div class="card-signin"><img src="<?= base_url('assets/user/images/Mark-email-read.svg')?>" loading="lazy" alt="" class="icon_error"></div>
          <div class="verify-content">
            <h1 class="semibolld text-align-center">Verifikasi Email Kamu</h1>
