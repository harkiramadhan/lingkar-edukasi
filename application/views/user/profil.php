                            ...
                            <div data-w-tab="Tab 2" class="w-tab-pane w--tab-active">
                                <div class="signin-form w-form">
                                    <div class="profile-foto_wrapper">
                                        <a href="#" class="profile-foto_edit w-inline-block"><img
                                            src="<?= base_url('assets/user/images/Mode-edit.svg')?>"
                                            loading="lazy"
                                            alt=""></a>
                                    </div>
                                    <form
                                        ...
                                        <label for="name-2" class="text-size-regular">No HP</label>
                                          <input
                                            ...
                                            name="name-2"
                                            data-name="nohp"
                                            placeholder="0821xxxxx"
                                            id="nohp"
                                            required="">
                                        <label for="name-3" class="text-size-regular">Jenis Kelamin</label>
                                          <select class="form-control form-control-lg default-select" tabindex="-98">
                                        ...
                                        <input
                                            ...
                                            class="button is-yellow margin-top-24 w-button"></form>
