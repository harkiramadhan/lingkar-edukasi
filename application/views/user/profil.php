      ...
      <div class="padding-top padding-60">
        <div class="container">
          ...
          <div class="profile-tabs-wrapper">
            <div data-current="Tab 2" data-easing="ease" data-duration-in="300" data-duration-out="100" class="profile-tabs w-tabs">
              <div class="profile-tabs_menu-wrapper w-tab-menu">
                <a data-w-tab="Tab 2" class="kelassaya-tabs_menu w-inline-block w-tab-link w--current">
                  <div>BIODATA</div>
                </a>
              ...
              <div class="profile-tabs_content w-tab-content">
                <div data-w-tab="Tab 2" class="w-tab-pane w--tab-active">
                  <div class="signin-form w-form">
                    <div class="profile-foto_wrapper">
                      <a href="#" class="profile-foto_edit w-inline-block"><img src="<?= base_url('assets/user/images/Mode-edit.svg')?>" loading="lazy" alt=""></a>
                    </div>
                    <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-field_wrapper"><label for="name" class="text-size-regular">Nama Lengkap</label><input type="text" class="text-field w-input" maxlength="256" name="name" data-name="Name" placeholder="Tulis nama lengkapmu" id="name" required=""><label for="password-2" class="text-size-regular">Email</label><input type="email" class="text-field w-input" maxlength="256" name="email" data-name="Email" placeholder="email@gmail.com" id="password" required=""><label for="name-2" class="text-size-regular">No HP</label><input type="text" class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="0821xxxxx" id="name-2" required=""><label for="name-3" class="text-size-regular">No HP</label><input type="text" class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="0821xxxxx" id="name-2" required=""><label for="name-3" class="text-size-regular">No HP</label><input type="text" class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="0821xxxxx" id="name-2" required=""><label for="name-3" class="text-size-regular">No HP</label><input type="text" class="text-field w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="0821xxxxx" id="name-2" required=""><input type="submit" value="MASUK" data-wait="Please wait..." class="button is-yellow margin-top-24 w-button"></form>
                ...
                <div data-w-tab="Tab 3" class="w-tab-pane">
                  <div class="signin-form w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-field_wrapper"><label for="name-3" class="text-size-regular">Password Lama</label>
                      <div class="text-field_block">
                        <div class="eye-icon_wrapper"><img src="<?= base_url('assets/user/images/Remove-red-eye.svg')?>" loading="lazy" alt="" class="eye-icon"></div><input type="password" class="text-field margin-bottom-20 w-input" maxlength="256" name="email" data-name="Email" placeholder="Tulis passwordmu" id="password" required="">
                      </div><label for="password" class="text-size-regular">Password Baru</label><input type="password" class="text-field w-input" maxlength="256" name="email" data-name="Email" placeholder="Tulis ulang passwordmu" id="password" required=""><input type="submit" value="Simpan" data-wait="Please wait..." class="button is-yellow margin-top-24 w-button">
                    </form>
                    <div class="w-form-done">
                      <div>Thank you! Your submission has been received!</div>
                    </div>
