          ...
          <div class="signin-content_left">
            <div class="siginin-form_wrapper">
              ...
              <div class="signin-form w-form">
                <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-field"><label for="password" class="text-size-regular margin-bottom-16">Password</label><input type="password" class="text-field margin-bottom-20 w-input" maxlength="256" name="email" data-name="Email" placeholder="Tulis passwordmu" id="password" required=""><label for="password" class="text-size-regular margin-bottom-16">Ulangi Password</label>
                  <div class="text-field_block">
                    <div class="eye-icon_wrapper"><img src="<?= base_url('assets/user/images/Remove-red-eye.svg')?>" loading="lazy" alt="" class="eye-icon"></div><input type="password" class="text-field margin-bottom-20 w-input" maxlength="256" name="email" data-name="Email" placeholder="Tulis ulang password" id="password" required="">
                  </div><input type="submit" value="BUAT PASSWORD" data-wait="Please wait..." class="button is-yellow margin-bottom-20 w-button">
                </form>
