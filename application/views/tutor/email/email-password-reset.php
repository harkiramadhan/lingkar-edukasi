																									...
																									<tr>
																										<td style="overflow-wrap:break-word;word-break:break-word;padding:44px 10px;font-family:'Open Sans',sans-serif;" align="left">
																											<div style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
																												<p style="line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;"><strong>ATUR ULANG PASSWORD</strong></span></p>
																											</div>
																										</td>
																									</tr>
																								</tbody>
																									...
																									<tr>
																										<td style="overflow-wrap:break-word;word-break:break-word;padding:35px 44px 10px;font-family:'Open Sans',sans-serif;" align="left">
																											<div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
																												<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 22px; line-height: 30.8px;">Hai <strong><?= $nama ?></strong>,</span></p>
																											</div>
																										</td>
																									</tr>
																								</tbody>
																									...
																									<tr>
																										<td style="overflow-wrap:break-word;word-break:break-word;padding:10px 44px 22px;font-family:'Open Sans',sans-serif;" align="left">
																											<div style="font-size: 14px; line-height: 190%; text-align: justify; word-wrap: break-word;">
																												<p style="font-size: 14px; line-height: 190%;">Kami telah menerima permintaan anda terkait <strong>pengaturan ulang password</strong></p>
																												<p style="font-size: 14px; line-height: 190%;">Klik tombol/link di bawah untuk melanjutkan</p>
																											</div>
																										</td>
																									</tr>
																								</tbody>
																											...
																											<div align="center">
																												...
																												<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:47px; v-text-anchor:middle; width:201px;" arcsize="87%"  stroke="f" fillcolor="#751119">
																													...
																													<center style="color:#FFFFFF;font-family:'Open Sans',sans-serif;">
																														<![endif]-->  
																														<a href="<?= site_url('tutor/tutor/setSession?u=' . md5($email)) ?>" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #751119; border-radius: 41px;-webkit-border-radius: 41px; -moz-border-radius: 41px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
																														  <span style="display:block;padding:15px 33px;line-height:120%;"><strong>Update Password</strong></span>
																														</a>
																														<!--[if mso]>
																													</center>
																												</v:roundrect>
																									...
																									<tr>
																										<td style="overflow-wrap:break-word;word-break:break-word;padding:10px 44px 22px;font-family:'Open Sans',sans-serif;" align="left">
																											<div style="font-size: 14px; line-height: 190%; text-align: center; word-wrap: break-word;">
																												<p style="font-size: 14px; line-height: 190%;">Bila ada pertanyaan, silahkan hubungi kami via <a href="#">WhatsApp.</a></p>
																											</div>
																										</td>
																									</tr>
																								</tbody>
