                ...
                <div class="card event-detail-bx overflow-hidden">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="<?= site_url('admin/course/update/' . $course->id) ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="single-select" class="form-control" name="pemateriid" required>
                                            <option value="" disabled>Pilih</option>
                                            <?php foreach($pemateri->result() as $pm){ ?>
                                                <option value="<?= $pm->id ?>" <?= ($pm->id == $course->pemateriid) ? 'selected' : '' ?>><?= $pm->nama ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
