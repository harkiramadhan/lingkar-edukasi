	...
	<div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('admin/course/createMateri') ?>" method="POST">
...
<div class="modal fade" id="modal-edit-materi">
	<div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('admin/course/updateMateri') ?>" method="POST">
                    <input type="hidden" name="courseid" value="<?= $course->id ?>">
                    <div class="form-group">
                        <label class="text-black font-w500">Judul Materi</label>
	...
	<div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= site_url('admin/course/createVideo') ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="courseid" value="<?= $course->id ?>">
	...
	<div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= site_url('admin/course/updateVideo') ?>" method="POST" enctype="multipart/form-data">
