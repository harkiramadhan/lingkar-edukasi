...
<html lang="en">
    ...
    <body>
        ...
        ***********************************-->
        <!-- Required vendors -->
        <script src="<?= base_url('assets/vendor/admin/global/global.min.js')?>"></script>
        <script src="<?= base_url('assets/vendor/admin/bootstrap-select/dist/js/bootstrap-select.min.js')?>"></script>
        <script src="<?= base_url('assets/vendor/admin/chart.js/Chart.bundle.min.js')?>"></script>
        <script src="<?= base_url('assets/js/admin/custom.min.js')?>"></script>
        <script src="<?= base_url('assets/js/admin/deznav-init.js')?>"></script>
        <script src="<?= base_url('assets/vendor/admin/owl-carousel/owl.carousel.js')?>"></script>
        
        <!-- Chart piety plugin files -->
        <script src="<?= base_url('assets/vendor/admin/peity/jquery.peity.min.js')?>"></script>
        
        <!-- Apex Chart -->
        <script src="<?= base_url('assets/vendor/admin/apexchart/apexchart.js')?>"></script>
        
        <!-- Dashboard 1 -->
        <script src="<?= base_url('assets/js/admin/dashboard/dashboard-1.js')?>"></script>
